function iColorShow(e, t) {
    _id = e;
    var n = jQuery("#" + t).position();
    jQuery("#iColorPicker,#icp_iframe").css({
        top: n.top + jQuery("#" + e).outerHeight() + 4 + "px",
        left: n.left - 100 + "px",
        position: "absolute"
    }).fadeIn("fast");
        ...
        for (j = 0; j < a; j++) {
            ...
            for (k = 0; k < l; k++) {
                ...
                jQuery(u[j].childNodes[k]).click(function() {
                    var t = "#" + jQuery(this).attr("hx");
                    tempColor = t;
                    jQuery("#" + e).css("background", t);
    ...
    jQuery("input.iColorPicker").each(function(e) {
        if (e == 0) {
            ...
            jQuery("#iColorPicker").css({
                ...
                color: "#fff",
                "z-index": 9999
            }).before('<iframe id="icp_iframe" width="253" height="155" scrolling="no" frameborder="0" style="z-index:99;display:none;background:#f00;"></iframe>')
        }
