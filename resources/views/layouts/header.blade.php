...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button" title="菜单">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="images/user/user2-160x160.jpg" class="img-circle"
                                                 alt="User Image"/>
                                        </div>
                                        <h4>
                                            Support Team
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="images/user/user3-128x128.jpg" class="img-circle"
                                                 alt="user image"/>
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="images/user/user4-128x128.jpg" class="img-circle"
                                                 alt="user image"/>
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown notifications-menu">
                    <a href="#" class="dropdown-toggle tixing" data-toggle="dropdown" title="提醒">
                ...
                <li class="dropdown tasks-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="进度">
                ...
                <li>
                    <a href="index.php?r=index/clear_cache" title="清空缓存" class="ajax-get">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="管理员">
